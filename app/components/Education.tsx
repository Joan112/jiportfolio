...
export default function Education() {
  const education = [
    {
      degree: "Lic. Informática",
      institution: "Escuela Informática de Navolato",
      period: "2013 - 2018",
      achievements: [
        "Desarrollo de proyectos prácticos enfocados en soluciones web y bases de datos.",
        "Adquisición de conocimientos sólidos en programación, algoritmos y estructuras de datos.",
        "Participación en proyectos colaborativos que fomentaron el trabajo en equipo y la resolución de problemas.",
      ],
    },
  ];
